...
> 「覆盖测试」原用 `TBD(<描述>)` 占位；开发测试阶段已全部替换为真实测试路径（`Tests/LangFixTests/*`）。
...
**覆盖测试**: `Tests/LangFixTests/ReviewWindowModeTests.swift::testResignKeyCollapsesWithoutCancel`、`Tests/LangFixTests/ReviewWindowModeTests.swift::testStateStillUpdatesWhileConceptuallyCollapsed`
...
**覆盖测试**: `Tests/LangFixTests/ReviewWindowModeTests.swift::testEscCollapsesWithoutCancel`、`Tests/LangFixTests/CloseSemanticsTests.swift::testEscAndResignDoNotCancel`
...
**覆盖测试**: `Tests/LangFixTests/ReviewWindowModeTests.swift::testTapCapsuleExpands`、`Tests/LangFixTests/ReviewWindowModeTests.swift::testStateStillUpdatesWhileConceptuallyCollapsed`
